...
namespace Restfull.Tests
{
    ...
    public class UpdateMessage
    {
        ...
        public void Setup()
        {
            ...
            // Nachricht 2 Verändern
            _tcp.GetData("PUT /messages/2 HTTP/1.1\n Host: 127.0.0.1:13000\n User-Agent: insomnia/2020.4.2\nAccept: */*\nContent-Length: 4\n\nnein");
            _tcp.UpdateMessage(_messageQue);
            _tcp.MakeHeader();
            ...
            // Put einer Nachricht mit falschem Index
            _tcp.GetData("PUT /messages/5 HTTP/1.1\n Host: 127.0.0.1:13000\n User-Agent: insomnia/2020.4.2\nAccept: */*\nContent-Length: 4\n\nIchBinFalschOderSo");
            _tcp.UpdateMessage(_messageQue);
            _tcp.MakeHeader();
            Result.Add(_tcp.GetHeader());
